...
- Issue #204 must not publish GitHub App user access tokens, refresh tokens,
  ...
  can mint and refresh App user tokens; a separate canary and follow-up CHG are
  required before any production resolver use.
